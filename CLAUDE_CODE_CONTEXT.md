...
## CURRENT STATUS (README Track-A audit — HEAD = dc6d1c0)
...
Status: not yet started. Scope: B1–B5 (product design, pipeline, demo).

### Completed this session
- ✅ A9 (Reproduce block): clean-stratum pipeline step 5 added — 4 verified offline
   commands (run_pool --analyze-only, run_phi_v_recompute, run_split_half_v2,
   run_null_control_v2). Committed dc6d1c0.
- Clean-stratum pipeline inputs committed (0fa51fb): tau1_final.json, clean_controls.json,
   panel_calib.json now tracked — the whole clean-stratum pipeline runs in a fresh clone.
...
- A8+A3: mislabel threat #1 added, threats renumbered, τ-construction scoped, v1/v2 framing corrected, clean split-half elevated (32dc694)
- Line 74 + A2 line 113: pool recommendation scoped, secondary→primary construct fix (2b462ff)
- (earlier) B5 line 568 + line 23 numeric fix (414ff38); agreement recompute provenance results/judgebench_v2_agreement_recompute.json (untracked)

OWNER STILL OPEN: rotate the Nebius key.
