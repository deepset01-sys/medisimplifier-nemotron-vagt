...
## CURRENT STATUS (README Track-A audit — HEAD = 7a386d3)

### Track-A residuals (open)
- A8: add ~85% mislabel as headline threat #1; re-scope split-half +0.052 as contaminated-label
- A2 line 113: secondary→primary construct definition
- A9: reproduces only automated pipeline — needs clean-stratum pipeline reference
- Line 74: "Nano recommended on merit" — scope note or update
- Lines 119/122: v1/v2 framing items

### Completed this session
- A6: full rewrite (db79b9c) — clean stratum replaces automated-pass diagnosis headline
- Lines 67+77: top-section corrected to match A6 (db79b9c)
