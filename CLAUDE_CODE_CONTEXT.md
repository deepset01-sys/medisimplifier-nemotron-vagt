...
## CURRENT STATUS (HEAD = c59f8e5 — Track-A complete; Track-B landed; README tail sections landed)
...
- ⬜ HF chambul/MedSimp-JudgeBench card: add the automated-label caveat (card is unchanged since v1).
- ⬜ HF chambul/medisimplifier-nemotron-dataset card: add the license (README says "not yet on HF card").
- ⬜ Publish JudgeBench v2 to HF (then update the Dataset and models row).
